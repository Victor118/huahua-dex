...
// source: chihuahua/dex/pool_reserves.proto
...
func (*PoolReservesKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_efd88eebca59c189, []int{0}
}
...
type PoolReserves struct {
	...
	PriceTakerToMaker         github_com_ChihuahuaChain_chihuahua_utils_math.PrecDec `protobuf:"bytes,3,opt,name=price_taker_to_maker,json=priceTakerToMaker,proto3,customtype=github.com/ChihuahuaChain/chihuahua/utils/math.PrecDec" json:"price_taker_to_maker" yaml:"price_taker_to_maker"`
	PriceOppositeTakerToMaker github_com_ChihuahuaChain_chihuahua_utils_math.PrecDec `protobuf:"bytes,4,opt,name=price_opposite_taker_to_maker,json=priceOppositeTakerToMaker,proto3,customtype=github.com/ChihuahuaChain/chihuahua/utils/math.PrecDec" json:"price_opposite_taker_to_maker" yaml:"price_opposite_taker_to_maker"`
}
...
func (*PoolReserves) Descriptor() ([]byte, []int) {
	return fileDescriptor_efd88eebca59c189, []int{1}
}
...
func init() {
	proto.RegisterType((*PoolReservesKey)(nil), "chihuahua.dex.PoolReservesKey")
	proto.RegisterType((*PoolReserves)(nil), "chihuahua.dex.PoolReserves")
}

func init() { proto.RegisterFile("chihuahua/dex/pool_reserves.proto", fileDescriptor_efd88eebca59c189) }

var fileDescriptor_efd88eebca59c189 = []byte{
	// 471 bytes of a gzipped FileDescriptorProto
	,
}
