...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"chihuahua", "dex", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LimitOrderTrancheUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"chihuahua", "dex", "limit_order_tranche_user", "address", "tranche_key"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LimitOrderTrancheUserAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"chihuahua", "dex", "limit_order_tranche_user"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LimitOrderTrancheUserAllByAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"chihuahua", "dex", "user", "limit_orders", "address"}, "", runtime.AssumeColonVerbOpt(false)))
